...
Security
Insights
boleto-api/boleto/template.html
@paulolimarb
paulolimarb add tag in all templates
Latest commit dbbf997 on 18 Dec 2019
 History
 4 contributors
@matheusanalista
485 lines (449 sloc)  66.4 KB
        ...
        <table cellspacing="0" cellpadding="0" border="1">
                ...
                <td width="70%" colspan="6">
                    ...
                    <table border="0" style="border:none">
                        <tr>
                            ...
                            <td><span class="text">CNPJ 01.000.000/0001-20</span></td>
                        </tr>
                    </table>
                    <br/>
                    <span class="text">Rua Simulação, 1 - Jardim do Dinheiro - São Paulo - SP - 10000-000</span>
                </td>
                <td width="30%">
            ...
            <tr>
                <td width="15%">
                    ...
                    <br/>
                    <p class="content center">01/07/2021</p>
                </td>
            ...
            <tr>
                ...
                <td>
                    ...
                    <br/>
                    <p class="content center"><1 class="dinheiro"></1>000,00</p>
                </td>
                <td width="30%">
                    <span class="title">(=) Valor do Documento</span>
                    <br/>
                    <br/>
                    <p class="content right">1.000,00</p>
                </td>
            </tr>
            <tr>
        ...
        <table cellspacing="0" cellpadding="0" border="1">
            <tr>
                ...
                <td width="30%">
                    ...
                    <br/>
                    <br/>
                    <p class="content right text" style="font-weight:bold;">01/10/2021</p>
                </td>
            </tr>
            <tr>
                <td width="70%" colspan="6">
            ...
            <tr>
                ...
                <td>
                    <span class="title">Valor</span>
                    <br/>
                    <p class="content center">1.000,00</p>
                </td>
                <td width="30%">
                    <span class="title">(=) Valor do Documento</span>
                    <br/>
